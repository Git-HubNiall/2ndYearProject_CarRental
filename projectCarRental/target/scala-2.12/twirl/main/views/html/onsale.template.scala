...
""")))}),format.raw/*13.2*/("""
               ...
               """),format.raw/*46.16*/("""<tr>
                  ...
                  <!-- Delete button -->
                    ...
                    """),_display_(/*72.22*/if((user != null) && ("customer".equals(user.getRole())))/*72.79*/ {_display_(Seq[Any](format.raw/*72.81*/("""
                        """),format.raw/*73.25*/("""<td><a href=""""),_display_(/*73.39*/routes/*73.45*/.ShoppingCtrl.addToBasket(i.getId)),format.raw/*73.79*/("""" 
    ...
    """),format.raw/*84.5*/("""<p>
        <a href=""""),_display_(/*85.19*/routes/*85.25*/.HomeController.addItem()),format.raw/*85.50*/("""">
