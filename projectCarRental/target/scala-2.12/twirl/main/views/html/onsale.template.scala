...
""")))}),format.raw/*13.2*/("""
    ...
    """),_display_(/*77.6*/if((user != null) && ("admin".equals(user.getRole())))/*77.60*/ {_display_(Seq[Any](format.raw/*77.62*/("""
    """),format.raw/*78.5*/("""<p>
        <a href=""""),_display_(/*79.19*/routes/*79.25*/.HomeController.addItem()),format.raw/*79.50*/("""">
