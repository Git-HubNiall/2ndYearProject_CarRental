...
<html>
	...
	<nav class="navbar navbar-inverse">
		...
		<ul class="nav navbar-nav">
			...
			"""),format.raw/*34.4*/("""</li>
				...
				"""),_display_(/*36.6*/if((user != null) && ("admin".equals(user.getRole())))/*36.60*/{_display_(Seq[Any](format.raw/*36.61*/("""
					"""),format.raw/*37.6*/("""<li """),_display_(/*37.11*/if(pagename == "Administrators")/*37.43*/ {_display_(Seq[Any](format.raw/*37.45*/("""class="active"""")))}),format.raw/*37.60*/("""></li><a href=""""),_display_(/*37.76*/routes/*37.82*/.HomeController.usersAdmin()),format.raw/*37.110*/("""">View Admin</a></li>	
				""")))}),format.raw/*38.6*/(""" 
	...
	<div class="container-fluid">
		...
		<div class="col-sm-8">
		    <div class="midcol">
			"""),_display_(/*55.5*/content),format.raw/*55.12*/("""
		    """),format.raw/*56.7*/("""</div>
		</div>
		<div class="col-sm-2">
		    <div class="well sidecol">
